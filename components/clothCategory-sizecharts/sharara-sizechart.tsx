...
export default function ShararaSizeChart({ onSizeSelect }: { onSizeSelect: (size: string) => void }) {
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50 text-gray-600">
                ...
                <th className="p-3 border-b border-gray-200 text-center font-medium">Top Waist</th>
                <th className="p-3 border-b border-gray-200 text-center font-medium">Hip</th>
                <th className="p-3 border-b border-gray-200 text-center font-medium">Top Length</th>
                <th className="p-3 border-b border-gray-200 text-center font-medium">Bottom Length</th>
                <th className="p-3 border-b border-gray-200 text-center font-medium">Bottom Waist</th>
              </tr>
            </thead>
            <tbody>
              {shararaSizeData.map((row, idx) => (
                ...
                >
                  ...
                  <td className="p-3 text-center">{row.topLength}</td>
                  <td className="p-3 text-center">{row.bottomLength}</td>
                  <td className="p-3 text-center">{row.bottomWaist}</td>
                </tr>
              ))}
            </tbody>
          </table>
