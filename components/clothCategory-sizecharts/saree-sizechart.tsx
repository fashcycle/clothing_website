...
export default function SareeSizeChart({
  onSizeSelect,
}: {
  ...
  const [selectedSleeveType, setSelectedSleeveType] =
    React.useState<string>("sleeveless");
          ...
          >
            ...
            <ul className="text-xs text-gray-600 space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  Measure from shoulder to desired blouse length.
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  Measure from shoulder point to desired sleeve length.
                </span>
              </li>
            </ul>
          </motion.div>
            ...
            <tbody>
              {sareeSizeData.map((row, idx) => (
                ...
                >
                  ...
                  <td className="p-3 border text-center">{row.sareeLength}</td>
                  <td className="p-3 border text-center">{row.blouseSize.bust}</td>
                  <td className="p-3 border text-center">{row.blouseSize.waist}</td>
                  <td className="p-3 border text-center">{row.blouseSize.shoulder}</td>
                  <td className="p-3 border text-center">{row.blouseSize.length}</td>
                  <td className="p-3 border text-center">{row.blouseSize.armhole}</td>
                  <td className="p-3 border text-center">
                    {
                      row.blouseSize.sleeveLength[
                        selectedSleeveType as keyof typeof row.blouseSize.sleeveLength
                      ]
                    }
                  </td>
                </tr>
          ...
          >
            <p className="text-sm flex items-center gap-2">
              ...
              <span>
                ...
                with {selectedSleeveType} sleeve. You can now proceed with your
                order.
              </span>
            </p>
          </motion.div>
