...
export default function OtherSizeChart({ onSizeSelect }: { onSizeSelect: (size: string) => void }) {
          ...
          >
            ...
            <ul className="text-xs text-gray-600 space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Measure from the shoulder to the desired length of the garment.</span>
              </li>
              <li className="flex items-start gap-2">
