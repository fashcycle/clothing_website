...
const category = params?.category || "Evening Dresses" // fallback in case category is not in URL
const formattedCategory = decodeURIComponent(category.toString().replace(/-/g, " "))
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-64 flex-shrink-0">
            <div className="bg-white">
              ...
              <FilterSection title="Product Type">
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="radio" name="productType" className="mr-2" defaultChecked />
                    <span className="text-sm">ALL</span>
                  </label>
                </div>
              </FilterSection>
              ...
              <FilterSection title="Brand">
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="radio" name="brand" className="mr-2" defaultChecked />
                    <span className="text-sm">ALL</span>
                  </label>
                </div>
              </FilterSection>
              ...
              <FilterSection title="Colour">
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="radio" name="colour" className="mr-2" defaultChecked />
                    <span className="text-sm">ALL</span>
                  </label>
                </div>
              </FilterSection>
              ...
              <div className="border-b border-gray-200 pb-4 mb-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Postage Available</span>
                  <Switch checked={postageAvailable} onCheckedChange={setPostageAvailable} />
                </div>
              </div>

              <div className="border-b border-gray-200 pb-4 mb-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Resale Available</span>
                  <Switch checked={resaleAvailable} onCheckedChange={setResaleAvailable} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">  {formattedCategory.charAt(0).toUpperCase() + formattedCategory.slice(1)}
</h1>
              <div className="text-gray-600 text-sm leading-relaxed">
                <p>
                  Hire a show-stopping evening dress no matter what the occasion is. Discover the curated Evening
                  Dresses featuring floor-length gowns & dazzling midi dresses with statement sleeves. There's something
                  for everyone, from brands such as Nadine Merabi, Saloni, The Vampire's Wife and more.
                  {showMore && (
                    <span>
                      {" "}
                      Our collection includes elegant black-tie options, cocktail dresses perfect for special events,
                      and glamorous pieces that will make you feel confident and beautiful. Whether you're attending a
                      wedding, gala, or formal dinner, find the perfect dress to rent for your special occasion.
                    </span>
                  )}
                </p>
                <Button
                ...
                >
                  <CardContent className="p-0">
                    ...
                    <div className="space-y-1">
                      <h3 className="font-medium text-gray-900">{product.size}</h3>
                      <p className="text-sm text-gray-600">{product.productName}</p>
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-gray-900">Rent from {product.originalPurchasePrice}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
