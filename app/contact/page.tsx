...
export default function ContactUs() {
        ...
        <CardContent className="p-0 md:flex">
          ...
          <div className="w-full md:w-1/2 px-6 py-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Are you a Renter or Lender?</label>
                <select
                  {...register('userType')}
                  className="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                >
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Tell us about your query</label>
                <textarea
                  {...register('message')}
  ...
  >
    {isSubmitting ? 'Sending...' : 'Submit'}
          ...
          <Card className="shadow-lg p-8 bg-primary text-primary-foreground w-[400px] min-h-[400px] flex flex-col justify-center">              <h1 className="text-lg italic underline mb-4">Need Help?</h1>
              ...
              <h2 className="text-lg italic font-semibold mt-6">Support that feels like a hug.</h2>
            </Card>
          </div>
        </CardContent>
      </Card>
